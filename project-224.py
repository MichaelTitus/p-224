...
def Bike_control():
    ...
    dropped_vehicle.apply_control(carla.VehicleControl(steer=-0.35,throttle=0.3))
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.HighBeam | carla.VehicleLightState.LeftBlinker| carla.VehicleLightState.Brake))
    time.sleep(2)
